export const posts = [
  {
    ...
    intro: "While freediving in Costa Brava I came across some beautiful soft corals that grow in the western Mediterranean: Eunicella singularis, known as white gorgonian.",
    date: "15/10/2019",
