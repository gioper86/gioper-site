...
const Articles = () => {
  ...
  return (
    <Container maxWidth="md" className={classes.root}>
      <div><Typography component="h5" variant="h5" className={classes.sectionHeader}>Ocean</Typography></div> 
      <div>
        <Typography component="body1" variant="body1">
          Sharing my love for the ocean. The videos and photos on this page come from my Instagram page and most of them were taken by me while freediving
        </Typography>
      </div> 
