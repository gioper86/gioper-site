...
const Articles = () => {
  ...
  const posts = InstaFeed.graphql.user.edge_owner_to_timeline_media.edges.map(
    (apost) => {
    ...
    <Container maxWidth="md" className={classes.root}>
      ...
      <div>
        <Typography component="body1" variant="body1">
          Sharing my love for the ocean. The videos and photos on this page come
          from my Instagram page and most of them were taken by me while
          freediving
        </Typography>
      </div>
